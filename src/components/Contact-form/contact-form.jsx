          ...
          <div className="col-lg-5 offset-lg-1">
            <div className="cont-info">
              ...
              <div className="social mt-50">
                <a href="https://github.com/amateur-dev" className="icon">
                  <i className="fab fa-github"></i>
                </a>
                <a href="https://twitter.com/amateurdev2" className="icon">
                  <i className="fab fa-twitter"></i>
                </a>
                <a href="https://www.linkedin.com/in/dipeshsukhani/" className="icon">
