                ...
                >
                    ...
                    <div className="info">
                      ...
                      <div className="cont">
                        <div className="author">
                          <h6 className="author-name ">Tiffany Teo</h6>
                          <span className="author-details">
                            Finance Manager at Tata Chemical International Pte Ltd
                          </span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="item">
                    ...
                    <div className="info">
                      ...
                      <div className="cont">
                        <div className="author">
                          <h6 className="author-name ">Samuel Ellis FCCA</h6>
                          <span className="author-details">
                            Head of Finance at InterWorks Europe
                          </span>
                        </div>
                      </div>
                    </div>
